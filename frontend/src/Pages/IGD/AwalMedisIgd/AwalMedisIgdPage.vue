...
import { useAwalMedisIgd } from "./useAwalMedisIgd"
  ...
  <section class="medical-page">
    ...
    <form v-else class="medical-form clinical-form-card clinical-form" @submit.prevent="save">
      <header class="clinical-section-header">
        <div><span>PENILAIAN MEDIS IGD</span><h3>{{ editing ? 'Edit' : 'Input' }} Awal Medis IGD</h3><p>Penilaian awal dokter pasien dewasa mengikuti form SIMRS.</p></div>
...
<style src="./awal-medis-igd.css" scoped></style>
