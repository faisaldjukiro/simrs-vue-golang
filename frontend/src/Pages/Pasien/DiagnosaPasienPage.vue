...
.theme-dark .patient-coding-card,.sirava-dark .patient-coding-card{border-color:#304258;background:#0c1625}.theme-dark .patient-coding-header,.theme-dark .patient-coding-section,.sirava-dark .patient-coding-header,.sirava-dark .patient-coding-section{border-color:#304258;background:#142132}.theme-dark .patient-coding-section>header,.theme-dark .patient-coding-list>article,.sirava-dark .patient-coding-section>header,.sirava-dark .patient-coding-list>article{border-color:#304258}.theme-dark .patient-coding-list code,.sirava-dark .patient-coding-list code{color:#60a5fa}.theme-dark .patient-coding-list article>i,.theme-dark .patient-coding-header>strong,.sirava-dark .patient-coding-list article>i,.sirava-dark .patient-coding-header>strong{color:#5eead4;background:rgba(20,184,166,.14)}.theme-dark .patient-coding-actions button,.sirava-dark .patient-coding-actions button{border-color:#3b4d64;color:#cbd5e1;background:#1c293b}.theme-dark .patient-coding-lock,.sirava-dark .patient-coding-lock{color:#fcd34d;background:rgba(120,53,15,.24)}
.patient-coding-list>article.procedure{grid-template-columns:62px minmax(0,1fr) 54px auto 94px}.patient-coding-quantity{display:grid;gap:3px;color:var(--muted);font-size:8px;font-weight:800}.patient-coding-quantity input{width:52px;height:29px;padding:0 6px;border:1px solid var(--line);border-radius:7px;color:var(--text);background:var(--surface-soft);font:inherit;font-size:10px}.patient-coding-quantity input:disabled{opacity:.75}.theme-dark .patient-coding-quantity input,.sirava-dark .patient-coding-quantity input{border-color:#3b4d64;color:#cbd5e1;background:#1c293b}
