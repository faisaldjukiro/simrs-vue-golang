...
<template>
  <section class="medical-page">
    ...
    <form v-else class="medical-form cppt-form-card cppt-form" @submit.prevent="save">
      ...
      <div v-if="billingLocked" class="medical-lock">Billing sudah terverifikasi atau kunjungan dibatalkan. Form Awal Medis Ranap hanya dapat dilihat.</div>
        ...
        <div class="medical-sheet">
          ...
          <section class="medical-section">
            ...
            <div class="medical-grid organ-grid">
              ...
              <FormInput v-model="form.jantung" label="Jantung" jenis="select" :options="pilihan.pemeriksaan"/>
              <FormInput v-model="form.paru" label="Paru" jenis="select" :options="pilihan.pemeriksaan"/>
          ...
          <section class="medical-section conclusion-section">
            ...
            <div class="medical-grid conclusion-grid">
              <FormInput v-model="form.lab" label="Laboratorium" jenis="textarea" :rows="3" maxlength="3000"/>
              <FormInput v-model="form.rad" label="Radiologi" jenis="textarea" :rows="3" maxlength="3000"/>
              <FormInput v-model="form.penunjang" class="wide" label="Pemeriksaan Penunjang Lainnya" jenis="textarea" :rows="3" maxlength="3000"/>
              <FormInput v-model="form.diagnosis" class="wide" label="Diagnosis / Asesmen" jenis="textarea" :rows="3" maxlength="500"/>
              <FormInput v-model="form.tata" label="Tatalaksana" jenis="textarea" :rows="5" maxlength="5000"/>
              <FormInput v-model="form.edukasi" label="Edukasi" jenis="textarea" :rows="5" maxlength="1000"/>
            </div>
          </section>
        </div>
