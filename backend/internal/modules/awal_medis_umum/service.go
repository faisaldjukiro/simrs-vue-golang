...
var (
	ErrInputTidakValid = errors.New("input penilaian awal medis umum tidak valid")
	ErrSudahAda        = errors.New("penilaian awal medis umum sudah tersedia")
	ErrTidakDitemukan  = errors.New("penilaian awal medis umum tidak ditemukan")
	ErrBillingTerkunci = errors.New("kunjungan sudah masuk billing; penilaian awal medis umum tidak dapat ditambah, diubah, atau dihapus")
)
