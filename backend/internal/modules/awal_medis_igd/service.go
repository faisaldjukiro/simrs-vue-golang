...
var (
	ErrInputTidakValid = errors.New("input penilaian Awal Medis IGD tidak valid")
	ErrSudahAda        = errors.New("penilaian Awal Medis IGD sudah tersedia")
	ErrTidakDitemukan  = errors.New("penilaian Awal Medis IGD tidak ditemukan")
	ErrBillingTerkunci = errors.New("kunjungan sudah masuk billing; penilaian Awal Medis IGD tidak dapat ditambah, diubah, atau dihapus")
)
