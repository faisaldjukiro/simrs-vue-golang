...
var ErrValidasi = errors.New("data NEWS Anak tidak valid")
...
const tabel = "pemantauan_news_anak"
...
func Kolom() []string {
	return []string{
		"tanggal", "temperatur_axila", "skor_temperatur_axila",
		"respirasi_rate", "skor_respirasi_rate", "denyut_nadi", "skor_denyut_nadi",
		"spo2", "skor_spo2", "satus_neurology", "skor_satus_neurology",
		"skor_total", "respon", "proses_eskalasi", "nip",
	}
}
